...
public class QuestionController {
	...
	public String addQuestion(@PathVariable("subject_id") Long subject_id, @Valid QuestionDTO questionDto,
	...
	public String editQuestionForm(@PathVariable("question_id") Long question_id, Model model)
	...
	public String updateQuestion(@PathVariable("question_id") Long question_id, @Valid QuestionDTO questionDto,
			BindingResult bindingResult, Model model) throws NotFoundException {
		if (bindingResult.hasErrors()) {
			Map<String, String> errorsMap = ControllerUtils.getErrors(bindingResult);
			model.mergeAttributes(errorsMap);
